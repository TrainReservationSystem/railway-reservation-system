...
import logo from "../../assets/trainLogo.jpg"
            ...
            <div className='row w-75'>
              <div className='col-md-12'>
                ...
                <div className='d-flex align-items-center mb-3'>
                  <label className='me-2 newClass display-1'>From</label>
                  <input type='text' className='form-control' placeholder='From Which Station ?' />
                </div>
                <div className='d-flex align-items-center mb-3'>
                  <label className='me-2 newClass display-1'>To</label>
                  <input type='text' className='form-control' placeholder='To Which Station ?' />
                </div>
                <div className='d-flex align-items-center mb-3'>
                  <label className='me-2 newClass display-1'>Date</label>
                  <DatePicker
                    selected={startDate}
                ...
                <br />
                  <Link to='/trainlist' className=' btn btn-outline-primary text-decoration-none'>Search</Link>
              </div>
          </div>
        </div>
